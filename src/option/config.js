...
export const dicOption = {
  ...
  eventList: ['tabs'],
  dataList: ['common', 'electricitystatistics',"unloadingplatform",'historicalload','loadpercentage','builder',"load",'tower','leaderboard','species','happening','effect', 'attendance','approach','jobtrends','subcontract','custeom', 'test', 'jlswiper', 'indexminppt', 'jlbar', 'jlbartwo', 'wordcloud', 'img', 'tabs', 'map', 'video', 'pie', 'pictorialbar', 'iframe', 'swiper', 'flop', 'bar', 'line', 'progress', 'table', 'gauge', 'funnel', 'scatter', 'radar'],
  // custList: ['custeom'], // 'test'
  themeList: [{
    label: '默认配色',
    value: 'avue'
  }, {
  ...
  barList: ['bar', 'jlbar', 'line'],
  titleList: ['bar', 'jlbar', 'pie', 'line', 'radar', 'funnel'],
  labelList: ['bar', 'jlbar', 'line', 'pie', 'radar', 'scatter'],
  legendList: ['bar', 'jlbar', 'pie', 'line', 'radar', 'funnel'],
  colorList: ['bar', 'jlbar', 'pie', 'line', 'gauge', 'funnel', 'scatter', 'radar'],
  tipList: ['bar', 'jlbar', 'pie', 'line', 'gauge', 'funnel', 'scatter', 'radar'],
  postionList: ['bar', 'jlbar', 'line', 'pictorialbar'],
  formatterList: ['bar', 'jlbar', 'map', 'line', 'pie', 'gauge', 'funnel', 'scatter', 'radar'],
  clickFormatterList: ['map'],
  labelFormatterList: ['bar', 'jlbar'],
  tabsTypeList: [{ 
    label: '选项卡',
    value: 'tabs',
  }, {
