...
import HeaderOption from './group/header/option';
...
export default {
  ...
  methods: {
    ...
    handleSetimg (val, type) {
      ...
      } else if (type === "activeObj.titleImage") {
        this.activeObj.titleImage = val;
      } else if (type === "activeObj.backgroundImage") {
        this.activeObj.backgroundImage = val;
