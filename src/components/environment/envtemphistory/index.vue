...
<script>
  ...
  export default {
            ...
            },
            {
              ...
              areaStyle: {
                normal: {
                  ...
                  shadowColor: "rgba(237,78,39, 0.9)",
                  shadowBlur: 20,
                },
              },
    ...
    methods: {
      dayRecord() {
        let url = `/prod-api/wisdomScreen/dust/wsDust/temperatureAndHumidityTrend`;
        axios
                .get(url, {
                  params: {
                ...
                .then((res) => {
                  if (res.data.code === 200) {
                    ...
                    this.chartOption.series[0].data = chartData.map(e => e.temperature)
                    this.chartOption.series[1].data = chartData.map(e => e.humidity)
                  }
                });
      },
    },
