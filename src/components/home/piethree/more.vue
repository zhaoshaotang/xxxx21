  ...
  >
    <div class="more-wrap">
      ...
      >
        ...
        <el-table-column
          label="整改期限"
          prop="repairLimitDate"
          align="center"
        ></el-table-column>
        <el-table-column
          label="检查人"
          prop="checkPositionName"
          align="center"
        ></el-table-column>
        <el-table-column
          label="整改人"
...
export default {
  ...
  methods: {
    handleOpen() {
      this.queryParams.qualityType = this.qualityType;
      this.queryParams.projectId = this.projectId;
      this.queryParams.companyId = this.companyId;
      this.getList();
    },
    getList() {
      let url = `/prod-api/wisdomScreen/home/wsHome/qualityAssuranceList`;
      axios
        .get(url, {
          params: {
            ...this.queryParams,
