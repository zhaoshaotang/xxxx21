<template>
  ...
  >
    <div class="more-wrap">
      ...
      <el-table
        ref="devTable"
        :data="tableData.slice((queryParams.pageNum-1)*queryParams.pageSize,queryParams.pageNum*queryParams.pageSize)"
        :show-header="true"
        stripe
...
export default {
  ...
  methods: {
    handleOpen() {
      this.queryParams.bjType = this.bjtype;
      this.queryParams.projectId = this.projectId;
      this.queryParams.companyId = this.companyId;
      this.getList();
    },
    getList() {
      let url = `/prod-api/wisdomScreen/elecbox/wsElecbox/detail`;
      axios
        .get(url, {
          params: {
            ...this.queryParams,
