...
export default {
  ...
  methods: {
    handleOpen() {
      ...
      this.queryParams.analysisType = this.analysisType;
      this.queryParams.regionName = this.regionName;
      this.queryParams.ageGroup = this.ageGroup;
      this.queryParams.genderType = this.genderType;
      this.queryParams.nationCode = this.nationCode;
      this.getList()
    },
    getList() {
      let url = `/prod-api/wisdomScreen/labour/wsLabour/constructionWorkerList`;
      axios
        .get(url, {
