    ...
    <div class="more-wrap">
      <div class="search-box">
        ...
        <div class="status-box">
         ...
         是否违章
        <div class="status-box">
          <el-select size="small" v-model="queryParams.whetherViolation" @change="change">     
...
export default {
  ...
  methods: {
    ...
    getList() {
      let url = `/prod-api/wisdomScreen/elevator/wsElevator/elevatorDTOWorkingConditionsDetails`;
      axios
        .get(url, {
